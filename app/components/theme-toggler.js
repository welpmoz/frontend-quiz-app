...
export default function ThemeToggler() {
	const toggleTheme = () => {
		let isNightMode = document.body.getAttribute('night-mode') === 'true';
	...
	return (
		<div className="header__theme-toggler">
			...
			<input
				className="header__switcher-input"
				id="theme-toggler"
				onChange={toggleTheme}
				type="checkbox"
			/>
			<label onKeyDown={handleKey} tabIndex={0} htmlFor="theme-toggler" className="header__switcher"></label>
